...
const router = async function (config) {
  ...
  appRouter.post('/db/:database/import/:collection', mongoMiddleware, upload.array('import-file'), configuredRoutes.importCollection);
  appRouter.post('/db/:database/import-bson/:collection', mongoMiddleware, upload.single('file'), configuredRoutes.importCollectionBSON);
